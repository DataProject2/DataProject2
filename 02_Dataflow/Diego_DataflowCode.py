...
def edemData(output_table):
    ...
    with beam.Pipeline(options=options) as p:
        ...
        data = (
            ...
            p | "Read messages from PubSub" >> beam.io.ReadFromPubSub(subscription=f"projects/lithe-window-342416/subscriptions/{output_table}-sub", with_attributes=True)
        ...
        (data | "Write to BigQuery" >> beam.io.WriteToBigQuery(
            table = f"lithe-window-342416:edemDataset.{output_table}",
            schema = schema,
